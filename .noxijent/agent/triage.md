...
Desktop application and browser-based app issues, including `noxijent web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core noxijent server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Noxijent Zen, Noxijent Go, and billing issues.
