...
- PR #10809: https://github.com/anomalyco/noxijent/pull/10809
- PR #11496: https://github.com/anomalyco/noxijent/pull/11496

## Do Not Translate (Locale Additions)

- `Noxijent` (preserve casing in prose; keep `noxijent` only in commands, package names, paths, or code)
- `Noxijent CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
