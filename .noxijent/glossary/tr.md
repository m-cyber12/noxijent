...
- PR #15835: https://github.com/anomalyco/noxijent/pull/15835

## Do Not Translate (Locale Additions)

- `Noxijent` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `noxijent` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Noxijent` in prose, `noxijent` only for exact technical identifiers
...
- Avoid changing `noxijent` to `Noxijent` inside commands, URLs, package names, or code literals
