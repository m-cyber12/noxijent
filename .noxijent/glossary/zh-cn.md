...
- PR #13942: https://github.com/anomalyco/noxijent/pull/13942

## Do Not Translate (Locale Additions)

- `Noxijent` (preserve casing in prose; keep `noxijent` only when it is part of commands, package names, paths, or code)
- `Noxijent Zen`
- `Noxijent CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `noxijent` in prose when referring to the product name; use `Noxijent`
