...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "noxijent", key: "dialog.provider.noxijent.note" },
  { match: (id: string) => id === "noxijent-go", key: "dialog.provider.noxijentGo.tagline" },
...
export const SettingsProvidersV2: Component<{
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "noxijent" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "noxijent" || item.id === "noxijent-go"}>
