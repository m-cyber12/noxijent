import type { SessionApi } from "@noxijent-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { NoxijentClient } from "@noxijent-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: NoxijentClient; directory: string; limit: number }) {
  try {
