import type { NoxijentEvent } from "@noxijent-ai/client/promise"
import type { Event } from "@noxijent-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: NoxijentEvent }
...
export function adaptServerEvent(event: NoxijentEvent): ServerEvent {
...
function currentDelta(event: NoxijentEvent | undefined): CurrentDelta | undefined {
  if (
