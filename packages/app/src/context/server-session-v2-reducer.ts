import type { NoxijentEvent, SessionMessageInfo, SessionPendingMessage } from "@noxijent-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: NoxijentEvent): V2SessionReduction | undefined => {
