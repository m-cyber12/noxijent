export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijent መጫን አልቻለም",
  "desktop.recovery.terminated": "Noxijent መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Noxijent ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijentመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.noxijentMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.noxijentCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Noxijent ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.noxijent.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.noxijentGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በNoxijent",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በNoxijent ይጠቀሙ።",
  ...
  "provider.connect.noxijentZen.line1": "Noxijent ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.noxijentZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.noxijentZen.visit.prefix": "ጎብኝ ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በNoxijent ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በNoxijent ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ noxijent.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Noxijent አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingNoxijent": "መፈተሽ Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Noxijentን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingNoxijent": "በማዘመን ላይ Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "በማዘመን ላይ Noxijent በ{{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "አዘምን Noxijent በ{{distro}}።",
  "wsl.onboarding.updateNoxijent": "አዘምን Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.noxijentReady": "Noxijent ዝግጁ ነው።",
  "wsl.onboarding.installNoxijentIn": "መጫን Noxijent በ{{distro}} ውስጥ።",
  "wsl.onboarding.installNoxijent": "ጫን Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijentአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Noxijent WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Noxijent በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Noxijent።",
  ...
  "help.tabs.introduction": "Noxijent ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የNoxijent ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለNoxijent ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (noxijent.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Noxijent እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Noxijent ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Noxijent ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የNoxijent አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለNoxijent",
  ...
  "settings.general.row.appearance.description": "Noxijentበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Noxijent ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Noxijent ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Noxijent ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የNoxijent እትም እያሄዱ ነው።",
