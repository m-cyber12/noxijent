export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Noxijent",
  "desktop.recovery.terminated": "توقفت نافذة Noxijent بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Noxijent لا يستجيب",
  ...
  "desktop.wsl.error.installNoxijent": "فشل تثبيت Noxijent",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.noxijentMissing": "noxijent غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.noxijentCannotRun": "noxijent مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Noxijent، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.noxijent.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.noxijent.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.noxijentGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Noxijent",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "يمنحك Noxijent Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "قم بزيارة ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Noxijent.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في noxijent.json",
  ...
  "dialog.server.description": "تبديل خادم Noxijent الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingNoxijent": "جارٍ التحقق من Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "جارٍ التحقق من Noxijent في {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "جارٍ تحديث Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "جارٍ تحديث Noxijent في {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "حدّث Noxijent في {{distro}}.",
  "wsl.onboarding.updateNoxijent": "تحديث Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent جاهز في {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent جاهز.",
  "wsl.onboarding.installNoxijentIn": "ثبّت Noxijent في {{distro}}.",
  "wsl.onboarding.installNoxijent": "تثبيت Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Noxijent من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Noxijent التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Noxijent.",
  ...
  "help.tabs.introduction": "أصبح Noxijent Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Noxijent ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Noxijent",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (noxijent.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Noxijent لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Noxijent نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Noxijent داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Noxijent",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Noxijent على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Noxijent يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Noxijent.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Noxijent",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Noxijent.",
