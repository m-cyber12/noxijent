export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijent yüklənə bilmədi",
  "desktop.recovery.terminated": "Noxijent pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Noxijent cavab vermir",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.noxijentMissing": "Bu distribütivdə noxijent quraşdırılmayıb",
  "desktop.wsl.error.noxijentCannotRun": "noxijent quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Noxijent yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.noxijent.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.noxijentGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "Noxijent tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Noxijent-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Noxijent-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Noxijent-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər noxijent.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Noxijent serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingNoxijent": "Noxijent yoxlanılır...",
  "wsl.onboarding.checkingNoxijentIn": "{{distro}}-də Noxijent yoxlanılır...",
  "wsl.onboarding.updatingNoxijent": "Noxijent yenilənir...",
  "wsl.onboarding.updatingNoxijentIn": "{{distro}}-də Noxijent yenilənir...",
  "wsl.onboarding.updateNoxijentIn": "{{distro}}-də Noxijent-u yeniləyin.",
  "wsl.onboarding.updateNoxijent": "Noxijent-u yeniləyin",
  "wsl.onboarding.noxijentReadyIn": "Noxijent {{distro}}-də hazırdır.",
  "wsl.onboarding.noxijentReady": "Noxijent hazırdır.",
  "wsl.onboarding.installNoxijentIn": "Noxijent-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installNoxijent": "Noxijent quraşdırın",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Noxijent WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Noxijent bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Noxijent-u yenidən açın.",
  ...
  "help.tabs.introduction": "Noxijent Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Noxijent-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Noxijent komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (noxijent.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Noxijent hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Noxijent serverini işlət.",
  ...
  "settings.general.row.language.description": "Noxijent üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Noxijent-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Noxijent-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Noxijent-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Noxijent açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Noxijent-un ən son versiyasından istifadə edirsiniz.",
