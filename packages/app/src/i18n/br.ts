export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Noxijent",
  ...
  "desktop.menu.ariaLabel": "Menu do Noxijent",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Noxijent",
  "desktop.recovery.terminated": "A janela do Noxijent foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Noxijent não está respondendo",
  ...
  "desktop.wsl.error.installNoxijent": "Falha na instalação do Noxijent",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.noxijentMissing": "O noxijent não está instalado nesta distribuição",
  "desktop.wsl.error.noxijentCannotRun": "O noxijent está instalado, mas não pôde ser executado",
  "desktop.wsl.error.noxijentNotInstalled": "O Noxijent não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Noxijent foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.noxijent.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.noxijentGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Visite ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Noxijent.",
  ...
  "dialog.plugins.empty": "Plugins configurados em noxijent.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Noxijent este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingNoxijent": "Verificando o Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Verificando o Noxijent em {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Atualizando o Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Atualizando o Noxijent em {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Atualize o Noxijent em {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Atualizar o Noxijent",
  "wsl.onboarding.noxijentReadyIn": "O Noxijent está pronto em {{distro}}.",
  "wsl.onboarding.noxijentReady": "O Noxijent está pronto.",
  "wsl.onboarding.installNoxijentIn": "Instale o Noxijent em {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instalar o Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Noxijent possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Noxijent não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Noxijent novamente.",
  ...
  "help.tabs.introduction": "Agora, o Noxijent Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Noxijent ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Noxijent",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (noxijent.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Noxijent ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Noxijent dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Noxijent",
  ...
  "settings.general.row.appearance.description": "Personalize como o Noxijent aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Noxijent segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Noxijent é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Noxijent iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Noxijent.",
