export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Noxijent",
  ...
  "desktop.menu.ariaLabel": "Noxijent meni",
  ...
  "desktop.recovery.loadFailed": "Noxijent se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Noxijent-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Noxijent ne reaguje",
  ...
  "desktop.wsl.error.installNoxijent": "Instalacija Noxijent-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.noxijentMissing": "noxijent nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.noxijentCannotRun": "noxijent je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Noxijent-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.noxijent.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.noxijentGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Noxijent-u.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Posjeti ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Noxijent-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Noxijent-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u noxijent.json",
  ...
  "dialog.server.description": "Promijeni na koji se Noxijent server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingNoxijent": "Provjera Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Provjera Noxijent u distribuciji {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Ažuriranje Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Ažuriranje Noxijent u distribuciji {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Ažuriraj Noxijent u distribuciji {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Ažuriraj Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent je spreman.",
  "wsl.onboarding.installNoxijentIn": "Instaliraj Noxijent u distribuciji {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instaliraj Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Noxijent mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Noxijent nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Noxijent-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Noxijent timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (noxijent.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Noxijent još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Noxijent server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Noxijent-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Noxijent izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Noxijent prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Noxijent-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Noxijent pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Noxijent-a.",
