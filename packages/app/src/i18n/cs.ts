export const dict = {
  ...
  "desktop.menu.documentation": "Noxijent Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Noxijent",
  ...
  "desktop.recovery.loadFailed": "Noxijent se nepodařilo načíst",
  "desktop.recovery.terminated": "Noxijent okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Noxijent nereaguje",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.noxijentMissing": "noxijent není v této distribuci nainstalováno",
  "desktop.wsl.error.noxijentCannotRun": "noxijent je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Noxijent aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.noxijent.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.noxijentGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Návštěva ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Noxijent.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v noxijent.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Noxijent serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingNoxijent": "Kontrola Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Kontrola Noxijent v {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Aktualizace Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Aktualizace Noxijent v {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Aktualizace Noxijent v {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Aktualizovat Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent je připraveno v {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent je připraven.",
  "wsl.onboarding.installNoxijentIn": "Nainstalujte Noxijent do {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instalovat Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Noxijent může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Noxijent nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Noxijent ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Noxijent",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (noxijent.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Noxijent zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Noxijent uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Noxijent",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Noxijent na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Noxijent následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Noxijent.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Noxijent",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Noxijent.",
