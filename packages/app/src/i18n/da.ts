export const dict = {
  ...
  "dialog.provider.noxijent.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.noxijent.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.noxijentGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.noxijentZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.noxijentZen.visit.prefix": "Besøg ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Noxijent.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i noxijent.json",
  ...
  "dialog.server.description": "Skift hvilken Noxijent-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingNoxijent": "Tjekker Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Tjekker Noxijent i {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Opdaterer Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Opdaterer Noxijent i {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Opdater Noxijent i {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Opdater Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Noxijent kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Noxijent kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Noxijent igen.",
  ...
  "toast.update.description": "En ny version af Noxijent ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Noxijent-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (noxijent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Noxijent understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Noxijent-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Noxijent",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Noxijent ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Noxijent skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Noxijents tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Noxijent starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Noxijent.",
  ...
  "desktop.recovery.loadFailed": "Noxijent kunne ikke indlæses",
  "desktop.recovery.terminated": "Noxijent-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installNoxijent": "Installationen af Noxijent mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.noxijentMissing": "noxijent er ikke installeret i denne distribution",
  "desktop.wsl.error.noxijentCannotRun": "noxijent er installeret, men kunne ikke køre",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Noxijent er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Noxijent Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
