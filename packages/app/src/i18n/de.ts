...
export const dict = {
  ...
  "dialog.provider.noxijent.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.noxijent.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.noxijentGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Noxijent zu nutzen.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Noxijent zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Noxijent zu nutzen.",
  ...
  "dialog.plugins.empty": "In noxijent.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Noxijent-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingNoxijent": "Noxijent wird geprüft…",
  "wsl.onboarding.checkingNoxijentIn": "Noxijent in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingNoxijent": "Noxijent wird aktualisiert…",
  "wsl.onboarding.updatingNoxijentIn": "Noxijent in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateNoxijentIn": "Aktualisieren Sie Noxijent in {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Noxijent aktualisieren",
  "wsl.onboarding.noxijentReadyIn": "Noxijent ist in {{distro}} bereit.",
  "wsl.onboarding.noxijentReady": "Noxijent ist bereit.",
  "wsl.onboarding.installNoxijentIn": "Installieren Sie Noxijent in {{distro}}.",
  "wsl.onboarding.installNoxijent": "Noxijent installieren",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Noxijent einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Noxijent konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Noxijent erneut.",
  ...
  "toast.update.description": "Eine neue Version von Noxijent ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Noxijent-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (noxijent.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Noxijent unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Noxijent mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Noxijent enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Noxijent Desktop",
  ...
  "settings.desktop.wsl.description": "Noxijent-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Noxijent ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Noxijent auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Noxijent dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Noxijent anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Noxijent automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Noxijent ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Noxijent wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Noxijent konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Noxijent-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Noxijent reagiert nicht",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.noxijentMissing": "noxijent ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.noxijentCannotRun": "noxijent ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Noxijent-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Noxijent Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
