...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Noxijent failed to load",
  "desktop.recovery.terminated": "Noxijent window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Noxijent is not responding",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.noxijentMissing": "noxijent is not installed in this distro",
  "desktop.wsl.error.noxijentCannotRun": "noxijent is installed but could not run",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Noxijent update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
