...
export const dict = {
  ...
  "dialog.provider.noxijent.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.noxijent.tagline": "Reliable optimized models",
  "dialog.provider.noxijentGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Noxijent.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.noxijentZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.noxijentZen.visit.prefix": "Visit ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Noxijent.",
  ...
  "dialog.plugins.empty": "Plugins configured in noxijent.json",
  ...
  "dialog.server.description": "Switch which Noxijent server this app connects to.",
  ...
  "wsl.onboarding.checkingNoxijent": "Checking Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Checking Noxijent in {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Updating Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Updating Noxijent in {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Update Noxijent in {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Update Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent is ready in {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent is ready.",
  "wsl.onboarding.installNoxijentIn": "Install Noxijent in {{distro}}.",
  "wsl.onboarding.installNoxijent": "Install Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Noxijent can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Noxijent could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Noxijent ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Noxijent team",
  ...
  "error.chain.checkConfig": "Check your config (noxijent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Noxijent does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Noxijent server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Noxijent",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Noxijent looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Noxijent follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Noxijent is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Noxijent launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Noxijent.",
