export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Noxijent",
  ...
  "desktop.menu.ariaLabel": "Menú de Noxijent",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Noxijent",
  "desktop.recovery.terminated": "La ventana de Noxijent se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Noxijent no responde",
  ...
  "desktop.wsl.error.installNoxijent": "No se pudo instalar Noxijent",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.noxijentMissing": "noxijent no está instalado en esta distribución",
  "desktop.wsl.error.noxijentCannotRun": "noxijent está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Noxijent finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.noxijent.tagline": "Modelos optimizados y fiables",
  "dialog.provider.noxijentGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.noxijentZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Noxijent.",
  ...
  "dialog.plugins.empty": "Plugins configurados en noxijent.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Noxijent al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingNoxijent": "Comprobando Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Comprobando Noxijent en {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Actualizando Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Actualizando Noxijent en {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Actualiza Noxijent en {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Actualizar Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent está listo en {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent está listo.",
  "wsl.onboarding.installNoxijentIn": "Instala Noxijent en {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instalar Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Noxijent pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Noxijent no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Noxijent ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Noxijent",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (noxijent.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Noxijent aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Noxijent dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Noxijent",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Noxijent en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Noxijent sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Noxijent.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Noxijent",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Noxijent.",
