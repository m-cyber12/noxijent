export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijent laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Noxijent aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Noxijent ei vasta",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.noxijentMissing": "noxijent pole sellesse distrosse installitud",
  "desktop.wsl.error.noxijentCannotRun": "noxijent on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Noxijent värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.noxijent.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.noxijentGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Noxijent'is.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Külastage ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Noxijent.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis noxijent.json",
  ...
  "dialog.server.description": "Lülitage, millise Noxijent serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingNoxijent": "Noxijent kontrollimine...",
  "wsl.onboarding.checkingNoxijentIn": "Noxijent kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Noxijent värskendamine...",
  "wsl.onboarding.updatingNoxijentIn": "Noxijent värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Värskenda Noxijent jaotises {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Värskenda Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent on valmis {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent on valmis.",
  "wsl.onboarding.installNoxijentIn": "Installige Noxijent asukohta {{distro}}.",
  "wsl.onboarding.installNoxijent": "Installige Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Noxijent saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Noxijent ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Noxijent ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Noxijent meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (noxijent.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Noxijent ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Noxijent Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Noxijent server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Noxijent kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Noxijent teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Noxijent järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Noxijent on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Noxijent käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Noxijent uusimat versiooni.",
