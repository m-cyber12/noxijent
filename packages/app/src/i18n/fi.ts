export const dict = {
  ...
  "dialog.provider.noxijent.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.noxijent.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.noxijentGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "Noxijentn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Noxijentssa.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Avaa ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Noxijentssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Noxijentssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään noxijent.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Noxijent-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingNoxijent": "Tarkistetaan Noxijenta...",
  "wsl.onboarding.checkingNoxijentIn": "Tarkistetaan Noxijenta kohteessa {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Päivitetään Noxijenta...",
  "wsl.onboarding.updatingNoxijentIn": "Päivitetään Noxijenta kohteessa {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Päivitä Noxijent jakelussa {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Päivitä Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent on valmis jakelussa {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent on valmis.",
  "wsl.onboarding.installNoxijentIn": "Asenna Noxijent jakeluun {{distro}}.",
  "wsl.onboarding.installNoxijent": "Asenna Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijenta ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Noxijent voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Noxijent ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Noxijent uudelleen.",
  ...
  "toast.update.description": "Noxijentn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Noxijent-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (noxijent.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Noxijent ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Noxijent-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Noxijentn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Noxijent näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Noxijent järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Noxijentn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Noxijent käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Noxijentn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Noxijent-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Noxijent-valikko",
  ...
  "desktop.recovery.loadFailed": "Noxijentn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Noxijent-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Noxijent ei vastaa",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijentn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.noxijentMissing": "noxijenta ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.noxijentCannotRun": "noxijent on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijenta ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Noxijentn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Noxijent Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
