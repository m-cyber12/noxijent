export const dict = {
  ...
  "desktop.menu.documentation": "Noxijent Skjøl",
  ...
  "desktop.menu.ariaLabel": "Noxijent valmynd",
  ...
  "desktop.recovery.loadFailed": "Noxijent miseydnaðist at heinta",
  "desktop.recovery.terminated": "Noxijent vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Noxijent svarar ikki",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.noxijentMissing": "noxijent er ikki sett upp í hesi distro",
  "desktop.wsl.error.noxijentCannotRun": "noxijent er sett upp men kundi ikki koyra",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Noxijent dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.noxijent.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.noxijent.tagline": "Álítandi optimerað modell",
  "dialog.provider.noxijentGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.noxijentZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.noxijentZen.visit.prefix": "Vitja ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Noxijent.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í noxijent.json",
  ...
  "dialog.server.description": "Skift hvønn Noxijent ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingNoxijent": "Kanna Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Kanna Noxijent í {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Dagføring Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Dagføring Noxijent í {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Dagfør Noxijent í {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Dagfør Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent er klárt í {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent er klárt.",
  "wsl.onboarding.installNoxijentIn": "Set Noxijent upp í {{distro}}.",
  "wsl.onboarding.installNoxijent": "Set upp Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Noxijent kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Noxijent kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Noxijent aftur.",
  ...
  "help.tabs.introduction": "Noxijent Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Noxijent ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Noxijent toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (noxijent.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Noxijent stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Noxijent Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Noxijent ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Noxijent",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Noxijent sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Noxijent fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Noxijent er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Noxijent byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Noxijent.",
