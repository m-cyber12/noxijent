export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Noxijent",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Noxijent",
  "desktop.recovery.terminated": "La fenêtre Noxijent s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Noxijent ne répond pas",
  ...
  "desktop.wsl.error.installNoxijent": "Échec de l'installation d'Noxijent",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.noxijentMissing": "noxijent n'est pas installé dans cette distribution",
  "desktop.wsl.error.noxijentCannotRun": "noxijent est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Noxijent est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.noxijent.tagline": "Modèles optimisés et fiables",
  "dialog.provider.noxijentGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Visitez ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Noxijent.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans noxijent.json",
  ...
  "dialog.server.description": "Changez le serveur Noxijent auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingNoxijent": "Vérification d'Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Vérification d'Noxijent dans {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Mise à jour d'Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Mise à jour d'Noxijent dans {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Mettez à jour Noxijent dans {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Mettre à jour Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent est prêt dans {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent est prêt.",
  "wsl.onboarding.installNoxijentIn": "Installez Noxijent dans {{distro}}.",
  "wsl.onboarding.installNoxijent": "Installer Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Noxijent puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Noxijent n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Noxijent ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Noxijent",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (noxijent.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Noxijent ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Noxijent inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Noxijent dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Noxijent",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Noxijent sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Noxijent suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Noxijent.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Noxijent",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Noxijent.",
