...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Noxijent se nije uspio učitati",
  "Prozor aplikacije Noxijent neočekivano je zatvoren",
  "Noxijent ne reagira",
  ...
  "Instalacija aplikacije Noxijent nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "noxijent nije instaliran u ovoj distribuciji",
  "noxijent je instaliran, ali se ne može pokrenuti",
  "Noxijent nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Noxijent je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.noxijent.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.noxijent.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.noxijentGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Posjetiti",
  "provider.connect.noxijentZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Noxijent.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u noxijent.json",
  ...
  "dialog.server.description": "Promijenite na koji se Noxijent poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingNoxijentIn": "Provjera Noxijent u {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Ažuriranje Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Ažuriranje Noxijent u {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Ažurirajte Noxijent u {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Ažurirajte Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent je spreman u {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent je spreman.",
  "wsl.onboarding.installNoxijentIn": "Instalirajte Noxijent u {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instalirajte Noxijent",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Noxijent može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Noxijent nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Noxijent.",
  ...
  "help.tabs.introduction": "Radna površina Noxijent sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Noxijent ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Noxijent timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (noxijent.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Noxijent još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Noxijent Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Noxijent poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Noxijent",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Noxijent izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Noxijent slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Noxijent tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Noxijent pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Noxijent.",
