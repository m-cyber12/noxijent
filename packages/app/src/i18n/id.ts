export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijent gagal dimuat",
  "desktop.recovery.terminated": "Jendela Noxijent berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Noxijent tidak merespons",
  ...
  "desktop.wsl.error.installNoxijent": "Instalasi Noxijent gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.noxijentMissing": "noxijent belum terinstal di distro ini",
  "desktop.wsl.error.noxijentCannotRun": "noxijent telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Noxijent selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.noxijent.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.noxijentGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Noxijent.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di noxijent.json",
  ...
  "dialog.server.description": "Ganti server Noxijent mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingNoxijent": "Memeriksa Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Memeriksa Noxijent di {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Memperbarui Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Memperbarui Noxijent di {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Perbarui Noxijent di {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Perbarui Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent siap di {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent siap.",
  "wsl.onboarding.installNoxijentIn": "Instal Noxijent di {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instal Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Noxijent dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Noxijent tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Noxijent ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Noxijent",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (noxijent.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Noxijent belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Noxijent di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Noxijent",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Noxijent di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Noxijent mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Noxijent diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Noxijent.",
