...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Noxijent",
  "Noxijent-glugganum var óvænt lokað",
  "Noxijent svarar ekki",
  ...
  "Uppsetning Noxijent mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "noxijent er ekki uppsett í þessari dreifingu",
  "noxijent er uppsett en ekki var hægt að keyra það",
  "Noxijent er ekki uppsett í {{distro}}",
  "Uppfærslu Noxijent lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.noxijent.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.noxijent.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.noxijentGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.noxijentZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.noxijentZen.visit.prefix": "Heimsókn",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Noxijent.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í noxijent.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Noxijent miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingNoxijent": "Athugar Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Athugar Noxijent í {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Uppfærir Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Uppfærir Noxijent í {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Uppfærðu Noxijent í {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Uppfærðu Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent er tilbúið í {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent er tilbúinn.",
  "wsl.onboarding.installNoxijentIn": "Settu upp Noxijent í {{distro}}.",
  "wsl.onboarding.installNoxijent": "Settu upp Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Noxijent getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Noxijent gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Noxijent aftur.",
  ...
  "help.tabs.introduction": "Noxijent Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Noxijent ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Noxijent teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (noxijent.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Noxijent styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Noxijent inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Noxijent skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Noxijent netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Noxijent",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Noxijent lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Noxijent fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Noxijent er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Noxijent ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Noxijent.",
