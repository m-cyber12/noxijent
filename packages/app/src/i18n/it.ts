export const dict = {
  ...
  "dialog.provider.noxijent.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.noxijent.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.noxijentGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.noxijentZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.noxijentZen.visit.prefix": "Visita ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Noxijent.",
  ...
  "dialog.plugins.empty": "Plugin configurati in noxijent.json",
  ...
  "dialog.server.description": "Cambia il server Noxijent a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingNoxijent": "Controllo Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Controllo Noxijent in {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Aggiornamento Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Aggiornamento Noxijent in {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Aggiorna Noxijent in {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Aggiorna Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent è pronto in {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent è pronto.",
  "wsl.onboarding.installNoxijentIn": "Installa Noxijent in {{distro}}.",
  "wsl.onboarding.installNoxijent": "Installa Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Noxijent possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Noxijent non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Noxijent ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Noxijent",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (noxijent.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Noxijent non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Noxijent all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Noxijent",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Noxijent sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Noxijent segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Noxijent.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Noxijent",
  ...
  "settings.updates.toast.latest.title": "Noxijent è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Noxijent.",
  ...
  "desktop.menu.documentation": "Documentazione di Noxijent",
  ...
  "desktop.menu.ariaLabel": "Menu Noxijent",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Noxijent",
  "desktop.recovery.terminated": "La finestra di Noxijent si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Noxijent non risponde",
  ...
  "desktop.wsl.error.installNoxijent": "Installazione di Noxijent non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.noxijentMissing": "noxijent non è installato in questa distribuzione",
  "desktop.wsl.error.noxijentCannotRun": "noxijent è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Noxijent è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
