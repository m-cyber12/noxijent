export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijentを読み込めませんでした",
  "desktop.recovery.terminated": "Noxijentのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Noxijentが応答していません",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijentのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.noxijentMissing": "このディストリビューションにはnoxijentがインストールされていません",
  "desktop.wsl.error.noxijentCannotRun": "noxijentはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.noxijentNotInstalled": "{{distro}}にはNoxijentがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Noxijentのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.noxijent.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.noxijent.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.noxijentGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Noxijentが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Noxijentで{{provider}}モデルを使用します。",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.noxijentZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.noxijentZen.visit.prefix": " ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNoxijentで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Noxijentで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "noxijent.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するNoxijentサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingNoxijent": "Noxijentを確認中...",
  "wsl.onboarding.checkingNoxijentIn": "{{distro}}内のNoxijentを確認中...",
  "wsl.onboarding.updatingNoxijent": "Noxijentを更新中...",
  "wsl.onboarding.updatingNoxijentIn": "{{distro}}内のNoxijentを更新中...",
  "wsl.onboarding.updateNoxijentIn": "{{distro}}内のNoxijentを更新してください。",
  "wsl.onboarding.updateNoxijent": "Noxijentを更新",
  "wsl.onboarding.noxijentReadyIn": "{{distro}}内のNoxijentの準備ができました。",
  "wsl.onboarding.noxijentReady": "Noxijentの準備ができました。",
  "wsl.onboarding.installNoxijentIn": "{{distro}}にNoxijentをインストールしてください。",
  "wsl.onboarding.installNoxijent": "Noxijentをインストール",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijentがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NoxijentでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Noxijentをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Noxijent Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Noxijentの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNoxijentチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (noxijent.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NoxijentはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Noxijentには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNoxijentサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Noxijentの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNoxijentの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Noxijentがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Noxijentのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Noxijent の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Noxijent は最新バージョンです。",
