...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Noxijent įkelti nepavyko",
  "Noxijent langas netikėtai užsidarė",
  "Noxijent neatsako",
  ...
  "Noxijent įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "noxijent šiame distributyve neįdiegtas",
  "noxijent įdiegtas, bet jo paleisti nepavyko",
  "Noxijent neįdiegtas distributyve {{distro}}",
  "Noxijent naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.noxijent.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.noxijent.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.noxijentGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Noxijent modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.noxijentZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.noxijentZen.visit.prefix": "Aplankykite",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Noxijent.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti noxijent.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Noxijent serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingNoxijent": "Tikrinama Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Tikrinama Noxijent {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Atnaujinamas Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Atnaujinamas Noxijent {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Atnaujinkite Noxijent {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Atnaujinkite Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent yra paruoštas {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent yra paruoštas.",
  "wsl.onboarding.installNoxijentIn": "Įdiekite Noxijent į {{distro}}.",
  "wsl.onboarding.installNoxijent": "Įdiekite Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Noxijent galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Noxijent nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Noxijent ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Noxijent komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (noxijent.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Noxijent dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Noxijent apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Noxijent darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Noxijent serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Noxijent ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Noxijent atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Noxijent seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Noxijent temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Noxijent",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Noxijent versiją.",
