export const dict = {
  ...
  "desktop.menu.documentation": "Noxijent dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Noxijent izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Noxijent",
  "desktop.recovery.terminated": "Noxijent logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Noxijent neatbild",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.noxijentMissing": "noxijent nav instalēts šajā distribūcijā",
  "desktop.wsl.error.noxijentCannotRun": "noxijent ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Noxijent atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.noxijent.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.noxijentGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Apmeklējiet",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Noxijent.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti noxijent.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Noxijent servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingNoxijent": "Pārbaudu Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Pārbaudu Noxijent distribūcijā {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Atjauninu Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Atjauninu Noxijent distribūcijā {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Atjauniniet Noxijent distribūcijā {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Atjauniniet Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent ir gatavs.",
  "wsl.onboarding.installNoxijentIn": "Instalējiet Noxijent distribūcijā {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instalējiet Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Noxijent var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Noxijent neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Noxijent no jauna.",
  ...
  "help.tabs.introduction": "Noxijent Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Noxijent versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Noxijent komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (noxijent.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Noxijent vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Noxijent darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Noxijent serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Noxijent saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Noxijent izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Noxijent sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Noxijent tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Noxijent",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Noxijent versiju.",
