export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Noxijent",
  ...
  "desktop.recovery.loadFailed": "Noxijent gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Noxijent ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Noxijent tidak memberi respons",
  ...
  "desktop.wsl.error.installNoxijent": "Pemasangan Noxijent gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.noxijentMissing": "noxijent tidak dipasang dalam distro ini",
  "desktop.wsl.error.noxijentCannotRun": "noxijent dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Noxijent selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.noxijent.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.noxijentGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Layari",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Noxijent.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam noxijent.json",
  ...
  "dialog.server.description": "Tukar pelayan Noxijent yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingNoxijent": "Sedang menyemak Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Sedang menyemak Noxijent dalam {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Sedang mengemas kini Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Sedang mengemas kini Noxijent dalam {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Kemas kini Noxijent dalam {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Kemas kini Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent sedia digunakan.",
  "wsl.onboarding.installNoxijentIn": "Pasang Noxijent dalam {{distro}}.",
  "wsl.onboarding.installNoxijent": "Pasang Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Noxijent boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Noxijent tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Noxijent ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Noxijent",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (noxijent.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Noxijent belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Noxijent dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Noxijent",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Noxijent pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Noxijent mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Noxijent.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Noxijent dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Noxijent.",
