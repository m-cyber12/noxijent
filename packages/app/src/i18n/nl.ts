export const dict = {
  ...
  "desktop.menu.documentation": "Noxijent-documentatie",
  ...
  "desktop.recovery.loadFailed": "Noxijent kan niet worden geladen",
  "desktop.recovery.terminated": "Het Noxijent-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Noxijent reageert niet",
  ...
  "desktop.wsl.error.installNoxijent": "Installatie van Noxijent is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.noxijentMissing": "noxijent is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.noxijentCannotRun": "noxijent is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Noxijent-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.noxijent.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.noxijentGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Noxijent te gebruiken.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.noxijentZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.noxijentZen.visit.prefix": "Ga naar ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Noxijent te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Noxijent te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in noxijent.json",
  ...
  "dialog.server.description": "Wijzig met welke Noxijent-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingNoxijent": "Noxijent controleren...",
  "wsl.onboarding.checkingNoxijentIn": "Noxijent controleren in {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Noxijent bijwerken...",
  "wsl.onboarding.updatingNoxijentIn": "Noxijent bijwerken in {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Werk Noxijent bij in {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Noxijent bijwerken",
  "wsl.onboarding.noxijentReadyIn": "Noxijent is gereed in {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent is klaar.",
  "wsl.onboarding.installNoxijentIn": "Installeer Noxijent in {{distro}}.",
  "wsl.onboarding.installNoxijent": "Installeer Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Noxijent een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Noxijent kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Noxijent opnieuw.",
  ...
  "help.tabs.introduction": "Noxijent Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Noxijent ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Noxijent-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (noxijent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Noxijent ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Noxijent-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Noxijent",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Noxijent eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Noxijent het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Noxijent aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Noxijent wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Noxijent is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Noxijent.",
