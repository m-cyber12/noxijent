...
export const dict = {
  ...
  "desktop.menu.documentation": "Noxijent-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Noxijent-meny",
  ...
  "desktop.recovery.loadFailed": "Noxijent kunne ikke lastes inn",
  "desktop.recovery.terminated": "Noxijent-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Noxijent svarer ikke",
  ...
  "desktop.wsl.error.installNoxijent": "Installasjonen av Noxijent mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.noxijentMissing": "noxijent er ikke installert i denne distribusjonen",
  "desktop.wsl.error.noxijentCannotRun": "noxijent er installert, men kunne ikke kjøres",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Noxijent er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.noxijent.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.noxijentGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Besøk ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Noxijent.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i noxijent.json",
  ...
  "dialog.server.description": "Bytt hvilken Noxijent-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Noxijent ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Noxijent-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (noxijent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Noxijent ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Noxijent-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Noxijent",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Noxijent ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Noxijent skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Noxijent.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Noxijent starter",
  ...
  "settings.updates.toast.latest.title": "Noxijent er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Noxijent.",
  ...
  "wsl.onboarding.checkingNoxijent": "Sjekker Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Sjekker Noxijent i {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Oppdaterer Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Oppdaterer Noxijent i {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Oppdater Noxijent i {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Oppdater Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent er klar i {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent er klar.",
  "wsl.onboarding.installNoxijentIn": "Installer Noxijent i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Noxijent kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Noxijent kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Noxijent på nytt.",
  ...
  "help.tabs.introduction": "Noxijent Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
