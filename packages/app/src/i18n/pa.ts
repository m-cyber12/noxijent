export const dict = {
  ...
  "desktop.menu.documentation": "Noxijent دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Noxijent لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Noxijent دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Noxijent جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.noxijentMissing": "اس ڈسٹرو وچ noxijent انسٹال نئیں اے",
  "desktop.wsl.error.noxijentCannotRun": "noxijent انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.noxijentNotInstalled": "{{distro}} وچ Noxijent انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Noxijent دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.noxijent.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.noxijent.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.noxijentGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.unpaid.freeModels.title": "Noxijent دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Noxijent وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.noxijentZen.visit.prefix": "ویکھو ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Noxijent وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Noxijent وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "noxijent.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Noxijent سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingNoxijent": "Noxijent چیک کر رئے آں...",
  "wsl.onboarding.checkingNoxijentIn": "{{distro}} چ Noxijent دی جانچ پڑتال...",
  "wsl.onboarding.updatingNoxijent": "Noxijent نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingNoxijentIn": "{{distro}} وچ Noxijent نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateNoxijentIn": "{{distro}} وچ Noxijent نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateNoxijent": "Noxijent اپ ڈیٹ کرو",
  "wsl.onboarding.noxijentReadyIn": "Noxijent {{distro}} چ تیار اے۔",
  "wsl.onboarding.noxijentReady": "Noxijent تیار اے۔",
  "wsl.onboarding.installNoxijentIn": "{{distro}} وچ Noxijent انسٹال کرو۔",
  "wsl.onboarding.installNoxijent": "Noxijent انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Noxijent دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Noxijent ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Noxijent دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Noxijent Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Noxijent ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Noxijent ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (noxijent.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Noxijent ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Noxijent چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Noxijent سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Noxijent لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Noxijent کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Noxijent سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Noxijent نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Noxijent لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Noxijent دا تازہ ترین ورژن چلا رئے او۔",
