export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Noxijent",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Noxijent",
  "desktop.recovery.terminated": "Okno Noxijent zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Noxijent nie odpowiada",
  ...
  "desktop.wsl.error.installNoxijent": "Nie udało się zainstalować Noxijent",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.noxijentMissing": "Program noxijent nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.noxijentCannotRun": "Program noxijent jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Noxijent została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.noxijent.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.noxijentGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Odwiedź ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Noxijent.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku noxijent.json",
  ...
  "dialog.server.description": "Przełącz serwer Noxijent, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingNoxijent": "Sprawdzanie Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Sprawdzanie Noxijent w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Aktualizowanie Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Aktualizowanie Noxijent w dystrybucji {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Zaktualizuj Noxijent w dystrybucji {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Zaktualizuj Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent jest gotowy.",
  "wsl.onboarding.installNoxijentIn": "Zainstaluj Noxijent w dystrybucji {{distro}}.",
  "wsl.onboarding.installNoxijent": "Zainstaluj Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Noxijent będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Noxijent nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Noxijent ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Noxijent",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (noxijent.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Noxijent nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Noxijent zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Noxijent wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Noxijent",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Noxijent na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Noxijent ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Noxijent.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Noxijent",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Noxijent.",
