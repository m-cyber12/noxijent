export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Noxijent",
  ...
  "desktop.menu.ariaLabel": "Meniu Noxijent",
  ...
  "desktop.recovery.loadFailed": "Noxijent nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Noxijent s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Noxijent nu răspunde",
  ...
  "desktop.wsl.error.installNoxijent": "Instalarea Noxijent a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.noxijentMissing": "noxijent nu este instalat în această distribuție",
  "desktop.wsl.error.noxijentCannotRun": "noxijent este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Noxijent s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.noxijent.tagline": "Modele optimizate, fiabile",
  "dialog.provider.noxijentGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.noxijentZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.noxijentZen.visit.prefix": "Vizitează",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Noxijent.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în noxijent.json",
  ...
  "dialog.server.description": "Schimbă serverul Noxijent la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingNoxijent": "Se verifică Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Se verifică Noxijent în {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Se actualizează Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Se actualizează Noxijent în {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Actualizează Noxijent în {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Actualizează Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent este gata în {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent este gata.",
  "wsl.onboarding.installNoxijentIn": "Instalează Noxijent în {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instalează Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Noxijent să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Noxijent nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Noxijent ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Noxijent",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (noxijent.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Noxijent nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Noxijent în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Noxijent",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Noxijent pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Noxijent urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Noxijent.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Noxijent",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Noxijent.",
