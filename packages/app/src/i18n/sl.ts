export const dict = {
  ...
  "desktop.menu.documentation": "Noxijent Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "Noxijent ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Noxijent se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Noxijent se ne odziva",
  ...
  "desktop.wsl.error.installNoxijent": "Namestitev Noxijent ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.noxijentMissing": "noxijent ni nameščen v tej distribuciji",
  "desktop.wsl.error.noxijentCannotRun": "noxijent je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Noxijent je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.noxijent.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.noxijentGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Obisk ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Noxijent.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v noxijent.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Noxijent se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingNoxijent": "Preverjanje Noxijent ...",
  "wsl.onboarding.checkingNoxijentIn": "Preverjanje Noxijent v {{distro}} ...",
  "wsl.onboarding.updatingNoxijent": "Posodabljanje Noxijent ...",
  "wsl.onboarding.updatingNoxijentIn": "Posodabljanje Noxijent v {{distro}} ...",
  "wsl.onboarding.updateNoxijentIn": "Posodobite Noxijent v {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Posodobite Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent je pripravljen v {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent je pripravljen.",
  "wsl.onboarding.installNoxijentIn": "Namestite Noxijent v {{distro}}.",
  "wsl.onboarding.installNoxijent": "Namestite Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Noxijent doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Noxijent ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Noxijent ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Noxijent",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (noxijent.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Noxijent še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Noxijent znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Noxijent",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Noxijent izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Noxijent sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Noxijent.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Noxijent",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Noxijent.",
