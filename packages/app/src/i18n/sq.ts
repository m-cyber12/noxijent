export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Noxijent",
  ...
  "desktop.menu.ariaLabel": "Menuja Noxijent",
  ...
  "desktop.recovery.loadFailed": "Noxijent nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Noxijent u mbyll papritur",
  "desktop.recovery.unresponsive": "Noxijent nuk po përgjigjet",
  ...
  "desktop.wsl.error.installNoxijent": "Instalimi i Noxijent dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.noxijentMissing": "Noxijent nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.noxijentCannotRun": "Noxijent është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Noxijent përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.noxijent.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.noxijentGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Vizitoni ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Noxijent.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në noxijent.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Noxijent lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingNoxijent": "Po kontrollon Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Po kontrollon Noxijent në {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Noxijent po përditësohet...",
  "wsl.onboarding.updatingNoxijentIn": "Po përditëson Noxijent në {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Përditëso Noxijent në {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Përditëso Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent është gati në {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent është gati.",
  "wsl.onboarding.installNoxijentIn": "Instaloni Noxijent në {{distro}}.",
  "wsl.onboarding.installNoxijent": "Instaloni Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Noxijent të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Noxijent nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Noxijent ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Noxijent",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (noxijent.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Noxijent nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Noxijent brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Noxijent",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Noxijent në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Noxijent ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Noxijent.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Noxijent",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Noxijent.",
