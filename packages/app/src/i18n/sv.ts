export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijent kunde inte läsas in",
  "desktop.recovery.terminated": "Noxijent-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Noxijent svarar inte",
  ...
  "desktop.wsl.error.installNoxijent": "Installationen av Noxijent misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.noxijentMissing": "noxijent är inte installerat i den här distributionen",
  "desktop.wsl.error.noxijentCannotRun": "noxijent är installerat men kunde inte köras",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Noxijent-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.noxijent.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.noxijent.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.noxijentGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.noxijentZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.noxijentZen.visit.prefix": "Besök ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Noxijent.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i noxijent.json",
  ...
  "dialog.server.description": "Växla vilken Noxijent-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingNoxijent": "Kontrollerar Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Kontrollerar Noxijent i {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Uppdaterar Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Uppdaterar Noxijent i {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Uppdatera Noxijent i {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Uppdatera Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent är redo i {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent är redo.",
  "wsl.onboarding.installNoxijentIn": "Installera Noxijent i {{distro}}.",
  "wsl.onboarding.installNoxijent": "Installera Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Noxijent kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Noxijent kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Noxijent igen.",
  ...
  "help.tabs.introduction": "Noxijent Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Noxijent ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Noxijent-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (noxijent.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Noxijent stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Noxijent-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Noxijent",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Noxijent ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Noxijent följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Noxijents tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Noxijent startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Noxijent.",
