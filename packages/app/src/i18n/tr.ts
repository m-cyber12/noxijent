...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijent yüklenemedi",
  "desktop.recovery.terminated": "Noxijent penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Noxijent yanıt vermiyor",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.noxijentMissing": "noxijent bu dağıtımda kurulu değil",
  "desktop.wsl.error.noxijentCannotRun": "noxijent kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Noxijent güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.noxijent.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.noxijentGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Noxijent tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Noxijent'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.noxijentZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Noxijent'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Noxijent'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler noxijent.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Noxijent sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingNoxijent": "Noxijent kontrol ediliyor...",
  "wsl.onboarding.checkingNoxijentIn": "{{distro}} içinde Noxijent kontrol ediliyor...",
  "wsl.onboarding.updatingNoxijent": "Noxijent güncelleniyor...",
  "wsl.onboarding.updatingNoxijentIn": "{{distro}} içinde Noxijent güncelleniyor...",
  "wsl.onboarding.updateNoxijentIn": "{{distro}} içindeki Noxijent'u güncelleyin.",
  "wsl.onboarding.updateNoxijent": "Noxijent'u güncelle",
  "wsl.onboarding.noxijentReadyIn": "{{distro}} içinde Noxijent hazır.",
  "wsl.onboarding.noxijentReady": "Noxijent hazır.",
  "wsl.onboarding.installNoxijentIn": "Noxijent'u {{distro}} içine kurun.",
  "wsl.onboarding.installNoxijent": "Noxijent'u kur",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Noxijent'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Noxijent bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Noxijent'u tekrar açın.",
  ...
  "help.tabs.introduction": "Noxijent Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Noxijent'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Noxijent ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (noxijent.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Noxijent henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Noxijent Masaüstü",
  ...
  "settings.desktop.wsl.description": "Noxijent sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Noxijent'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Noxijent'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Noxijent'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Noxijent'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Noxijent başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Noxijent'un en son sürümünü kullanıyorsunuz.",
