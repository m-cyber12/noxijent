export const dict = {
  ...
  "desktop.menu.documentation": "Документація Noxijent",
  ...
  "desktop.menu.ariaLabel": "Меню Noxijent",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Noxijent",
  "desktop.recovery.terminated": "Роботу вікна Noxijent несподівано завершено",
  "desktop.recovery.unresponsive": "Noxijent не відповідає",
  ...
  "desktop.wsl.error.installNoxijent": "Не вдалося встановити Noxijent",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.noxijentMissing": "noxijent не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.noxijentCannotRun": "noxijent встановлено, але його не вдалося запустити",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Noxijent завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.noxijent.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.noxijentGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Noxijent",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Відвідайте ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Noxijent.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в noxijent.json",
  ...
  "dialog.server.description": "Перемкніть сервер Noxijent, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingNoxijent": "Перевірка Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Перевірка Noxijent у {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Оновлення Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Оновлення Noxijent у {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Оновіть Noxijent у {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Оновити Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent готовий до роботи у {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent готовий до роботи.",
  "wsl.onboarding.installNoxijentIn": "Встановіть Noxijent у {{distro}}.",
  "wsl.onboarding.installNoxijent": "Встановити Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Noxijent потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Noxijent не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Noxijent ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Noxijent",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (noxijent.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Noxijent ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Noxijent всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Noxijent",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Noxijent на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Noxijent використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Noxijent.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Noxijent",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Noxijent.",
