export const dict = {
  ...
  "desktop.menu.documentation": "Noxijent hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Noxijent menyusi",
  ...
  "desktop.recovery.loadFailed": "Noxijent yuklanmadi",
  "desktop.recovery.terminated": "Noxijent oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Noxijent javob bermayapti",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.noxijentMissing": "Noxijent ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.noxijentCannotRun": "noxijent o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Noxijent yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.noxijent.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.noxijentGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "Noxijent tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Noxijent’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Noxijent da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Noxijent da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "noxijent.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Noxijent serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingNoxijent": "Noxijent tekshirilmoqda...",
  "wsl.onboarding.checkingNoxijentIn": "Noxijent {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingNoxijent": "Noxijent yangilanmoqda...",
  "wsl.onboarding.updatingNoxijentIn": "Noxijent {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateNoxijentIn": "Noxijent-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateNoxijent": "Noxijent-ni yangilang",
  "wsl.onboarding.noxijentReadyIn": "Noxijent {{distro}} da tayyor.",
  "wsl.onboarding.noxijentReady": "Noxijent tayyor.",
  "wsl.onboarding.installNoxijentIn": "Noxijent-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installNoxijent": "Noxijent-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Noxijent WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Noxijent WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Noxijent-ni qayta oching.",
  ...
  "help.tabs.introduction": "Noxijent Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Noxijent ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Noxijent jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (noxijent.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Noxijent hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Noxijent bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Noxijent serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Noxijent uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Noxijent qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Noxijent tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Noxijent mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Noxijent ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Noxijent oxirgi versiyasini ishga tushiryapsiz.",
