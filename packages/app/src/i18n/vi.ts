export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Noxijent",
  ...
  "desktop.recovery.loadFailed": "Không tải được Noxijent",
  "desktop.recovery.terminated": "Cửa sổ Noxijent đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Noxijent không phản hồi",
  ...
  "desktop.wsl.error.installNoxijent": "Không cài đặt được Noxijent",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.noxijentMissing": "noxijent chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.noxijentCannotRun": "noxijent đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.noxijentNotInstalled": "Noxijent chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Noxijent nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.noxijent.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.noxijent.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.noxijentGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Noxijent cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Noxijent.",
  ...
  "provider.connect.noxijentZen.line1":
    "Noxijent Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.noxijentZen.visit.prefix": "Truy cập ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Noxijent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Noxijent.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong noxijent.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Noxijent mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingNoxijent": "Đang kiểm tra Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "Đang kiểm tra Noxijent trong {{distro}}...",
  "wsl.onboarding.updatingNoxijent": "Đang cập nhật Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "Đang cập nhật Noxijent trong {{distro}}...",
  "wsl.onboarding.updateNoxijentIn": "Cập nhật Noxijent trong {{distro}}.",
  "wsl.onboarding.updateNoxijent": "Cập nhật Noxijent",
  "wsl.onboarding.noxijentReadyIn": "Noxijent đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.noxijentReady": "Noxijent đã sẵn sàng.",
  "wsl.onboarding.installNoxijentIn": "Cài đặt Noxijent trong {{distro}}.",
  "wsl.onboarding.installNoxijent": "Cài đặt Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "Noxijent chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Noxijent có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Noxijent không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Noxijent.",
  ...
  "help.tabs.introduction": "Noxijent Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Noxijent ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Noxijent",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (noxijent.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Noxijent chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Noxijent bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Noxijent bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Noxijent",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Noxijent trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Noxijent tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Noxijent.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Noxijent khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Noxijent.",
