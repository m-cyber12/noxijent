...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijent 加载失败",
  "desktop.recovery.terminated": "Noxijent 窗口意外终止",
  "desktop.recovery.unresponsive": "Noxijent 未响应",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent 安装失败",
  "desktop.wsl.error.alreadyAdded": "已添加 {{distro}}",
  "desktop.wsl.error.noxijentMissing": "此发行版中未安装 noxijent",
  "desktop.wsl.error.noxijentCannotRun": "已安装 noxijent，但无法运行",
  "desktop.wsl.error.noxijentNotInstalled": "{{distro}} 中未安装 Noxijent",
  "desktop.wsl.error.updateVersion":
    "Noxijent 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.provider.noxijent.note": "精选模型，包括 Claude、GPT、Gemini 等",
  "dialog.provider.noxijent.tagline": "可靠的优化模型",
  "dialog.provider.noxijentGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Noxijent 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Noxijent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.noxijentZen.line1": "Noxijent Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.noxijentZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.noxijentZen.visit.prefix": "访问 ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Noxijent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Noxijent 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 noxijent.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Noxijent 服务器。",
  ...
  "wsl.onboarding.checkingNoxijent": "正在检查 Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "正在检查 {{distro}} 中的 Noxijent...",
  "wsl.onboarding.updatingNoxijent": "正在更新 Noxijent...",
  "wsl.onboarding.updatingNoxijentIn": "正在更新 {{distro}} 中的 Noxijent...",
  "wsl.onboarding.updateNoxijentIn": "更新 {{distro}} 中的 Noxijent。",
  "wsl.onboarding.updateNoxijent": "更新 Noxijent",
  "wsl.onboarding.noxijentReadyIn": "{{distro}} 中的 Noxijent 已就绪。",
  "wsl.onboarding.noxijentReady": "Noxijent 已就绪。",
  "wsl.onboarding.installNoxijentIn": "在 {{distro}} 中安装 Noxijent。",
  "wsl.onboarding.installNoxijent": "安装 Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "未安装 Noxijent",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Noxijent 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Noxijent 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Noxijent。",
  ...
  "help.tabs.introduction": "Noxijent Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Noxijent 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Noxijent 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (noxijent.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Noxijent 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Noxijent 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Noxijent 服务器。",
  ...
  "settings.general.row.language.description": "更改 Noxijent 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Noxijent 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Noxijent 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Noxijent 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Noxijent 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Noxijent。",
