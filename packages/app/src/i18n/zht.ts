...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Noxijent 載入失敗",
  "desktop.recovery.terminated": "Noxijent 視窗意外終止",
  "desktop.recovery.unresponsive": "Noxijent 沒有回應",
  ...
  "desktop.wsl.error.installNoxijent": "Noxijent 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.noxijentMissing": "此發行版中未安裝 noxijent",
  "desktop.wsl.error.noxijentCannotRun": "已安裝 noxijent，但無法執行",
  "desktop.wsl.error.noxijentNotInstalled": "{{distro}} 中未安裝 Noxijent",
  "desktop.wsl.error.updateVersion":
    "Noxijent 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.noxijent.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.noxijent.tagline": "經過最佳化的可靠模型",
  "dialog.provider.noxijentGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Noxijent 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Noxijent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.noxijentZen.line1": "Noxijent Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.noxijentZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.noxijentZen.visit.prefix": "造訪 ",
  "provider.connect.noxijentZen.visit.link": "noxijent.ai/zen",
  "provider.connect.noxijentZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Noxijent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Noxijent 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 noxijent.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Noxijent 伺服器。",
  ...
  "wsl.onboarding.checkingNoxijent": "正在檢查 Noxijent...",
  "wsl.onboarding.checkingNoxijentIn": "正在檢查 {{distro}} 中的 Noxijent...",
  ...
  "wsl.onboarding.noxijentReadyIn": "{{distro}} 中的 Noxijent 已就緒。",
  "wsl.onboarding.noxijentReady": "Noxijent 已就緒。",
  "wsl.onboarding.installNoxijentIn": "在 {{distro}} 中安裝 Noxijent。",
  "wsl.onboarding.installNoxijent": "安裝 Noxijent",
  ...
  "wsl.onboarding.distroStatus.noxijentMissing": "未安裝 Noxijent",
  ...
  "wsl.onboarding.wslUnavailable.description": "Noxijent 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Noxijent。",
  ...
  "help.tabs.introduction": "Noxijent Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Noxijent 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Noxijent 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (noxijent.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Noxijent 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Noxijent 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Noxijent 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Noxijent 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Noxijent 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Noxijent 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Noxijent 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Noxijent 啟動時自動檢查更新",
