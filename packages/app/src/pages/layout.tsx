...
import { base64Encode } from "@noxijent-ai/core/util/encode"
...
import { Session } from "@noxijent-ai/sdk/v2/client"
...
import { retry } from "@noxijent-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@noxijent-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://noxijent.ai/desktop-feedback")}
      renderPanel={() =>
