...
const GLOBAL_STORAGE = "noxijent.global.dat"
const WINDOW_STORAGE = "noxijent.window"
const LOCAL_PREFIX = "noxijent."
...
function workspaceStorage(dir: string) {
  ...
  return `noxijent.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `noxijent.draft.${head}.${sum}.dat`
}
