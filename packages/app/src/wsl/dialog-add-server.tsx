...
import { showToast } from "@noxijent-ai/ui/toast"
import { ButtonV2 } from "@noxijent-ai/ui/v2/button-v2"
import { Dialog, DialogBody, DialogFooter, DialogHeader, DialogTitle } from "@noxijent-ai/ui/v2/dialog-v2"
import { DividerV2 } from "@noxijent-ai/ui/v2/divider-v2"
import { LoaderV2 } from "@noxijent-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@noxijent-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-noxijent") {
      await run(() => api.installNoxijent(distro))
      return
    }
