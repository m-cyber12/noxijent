...
declare const NOXIJENT_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof NOXIJENT_CLI_NAME === "string" ? NOXIJENT_CLI_NAME : "noxijent", {
  description: "Noxijent 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
