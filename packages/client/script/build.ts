...
import { compile, emitEffectImported, emitPromise, write } from "@noxijent-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "NoxijentEventEncoded",
              import: 'import type { NoxijentEventEncoded } from "@noxijent-ai/protocol/groups/event"',
            },
          },
        }),
