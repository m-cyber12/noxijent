      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://noxijent.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>noxijent.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g noxijent-ai")}>
                <code>
                  npm i -g <strong>noxijent-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g noxijent-ai")}>
                <code>
                  bun add -g <strong>noxijent-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/noxijent")}>
                <code>
                  brew install <strong>anomalyco/tap/noxijent</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S noxijent")}>
                <code>
                  paru -S <strong>noxijent</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask noxijent-desktop")}>
                <code>
                  brew install --cask <strong>noxijent-desktop</strong>
                </code>
                <CopyStatus />
              </button>
