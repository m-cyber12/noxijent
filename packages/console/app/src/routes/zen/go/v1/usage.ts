...
import { and, Database, eq, isNull } from "@noxijent-ai/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@noxijent-ai/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "Noxijent Go subscription required.",
        },
      }),
      {
        status: 403,
