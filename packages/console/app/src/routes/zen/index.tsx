...
import compareVideo from "../../asset/lander/noxijent-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/noxijent-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="noxijent:auth" content={loggedin() ? "true" : "false"} />
