...
import { Credential } from "@noxijent-ai/schema/credential"
import { Integration } from "@noxijent-ai/schema/integration"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/v2/Credential") {}
