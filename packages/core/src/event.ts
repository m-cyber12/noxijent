...
import type { Data, Definition, Payload } from "@noxijent-ai/schema/event"
...
import { Durable } from "@noxijent-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@noxijent-ai/schema/event").ID
export type { Data, Definition, Payload } from "@noxijent-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/Event") {}
