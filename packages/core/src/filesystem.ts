...
import { Entry, FileSystem, FindInput, Match } from "@noxijent-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@noxijent-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/v2/FileSystem") {}
