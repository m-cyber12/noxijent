...
export class Service extends Context.Service<Service, Interface>()("@noxijent/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.NOXIJENT_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
