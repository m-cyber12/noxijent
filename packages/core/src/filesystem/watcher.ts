...
import { FileSystemWatcher } from "@noxijent-ai/schema/filesystem-watcher"
...
declare const NOXIJENT_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof NOXIJENT_LIBC === "undefined" ? undefined : NOXIJENT_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.NOXIJENT_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.NOXIJENT_EXPERIMENTAL_FILEWATCHER)) {
