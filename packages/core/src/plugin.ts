...
import type { Plugin as PluginRuntime } from "@noxijent-ai/plugin/v2/effect"
import { Plugin } from "@noxijent-ai/schema/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/v2/Plugin") {}
