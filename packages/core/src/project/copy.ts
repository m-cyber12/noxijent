...
import { Event } from "@noxijent-ai/schema/project-directories"
import { ProjectCopy } from "@noxijent-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/ProjectCopy") {}
