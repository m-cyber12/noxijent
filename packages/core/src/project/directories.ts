...
import type { EffectDrizzleSqlite } from "@noxijent-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/ProjectDirectories") {}
