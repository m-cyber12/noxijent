...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@noxijent-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/v2/ToolRegistry") {}
