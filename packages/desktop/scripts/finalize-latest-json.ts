...
const releaseId = process.env.NOXIJENT_RELEASE
if (!releaseId) throw new Error("NOXIJENT_RELEASE is required")

const version = process.env.NOXIJENT_VERSION
if (!version) throw new Error("NOXIJENT_VERSION is required")
...
const macxTarGz = "noxijent-desktop-mac-x64.app.tar.gz"
const macaTarGz = "noxijent-desktop-mac-arm64.app.tar.gz"
