...
const desktopStateNames = ["ai.noxijent.desktop.dev", "ai.noxijent.desktop.beta", "ai.noxijent.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "noxijent-cli.exe" : "noxijent-cli"
}
