...
const SIDECAR_SERVICE_NAME = "noxijent server"
...
export function preferAppEnv(userDataPath: string) {
  ...
  Object.assign(process.env, {
    ...shellEnv,
    NOXIJENT_EXPERIMENTAL_ICON_DISCOVERY: "true",
    NOXIJENT_EXPERIMENTAL_FILEWATCHER: "true",
    NOXIJENT_CLIENT: "desktop",
...
export async function checkHealth(url: string, password?: string | null): Promise<boolean> {
  ...
  if (password) {
    const auth = Buffer.from(`noxijent:${password}`).toString("base64")
