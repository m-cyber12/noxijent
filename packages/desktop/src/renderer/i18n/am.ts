export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የNoxijent ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከNoxijent ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
