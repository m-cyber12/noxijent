export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Noxijent uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Noxijent'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „noxijent” kasutamiseks taaskäivitage terminal.",
