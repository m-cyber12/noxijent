export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Noxijentn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Noxijentn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Noxijentn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'noxijent'-komentoa.",
