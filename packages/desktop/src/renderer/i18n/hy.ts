export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք Noxijent-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "Noxijent-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «noxijent» հրամանն օգտագործելու համար:",
