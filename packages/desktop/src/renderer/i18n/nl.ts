export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Noxijent",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Noxijent is gedownload. Wil je deze installeren en Noxijent opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'noxijent' te gebruiken.",
