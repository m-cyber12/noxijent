export const dict = {
  ...
  "desktop.updater.none.message": "Noxijent-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Noxijent-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'noxijent' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
