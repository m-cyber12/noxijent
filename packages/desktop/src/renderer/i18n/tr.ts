export const dict = {
  ...
  "desktop.updater.none.message": "Noxijent'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Noxijent'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'noxijent' komutunu kullanmak için terminalinizi yeniden başlatın.",
