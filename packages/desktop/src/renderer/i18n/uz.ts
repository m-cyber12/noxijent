export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Noxijent ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Noxijentning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'noxijent' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
