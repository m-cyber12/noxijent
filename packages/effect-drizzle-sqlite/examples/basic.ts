...
class Database extends Context.Service<Database, DatabaseShape>()("@noxijent/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@noxijent/example/UserStore") {
