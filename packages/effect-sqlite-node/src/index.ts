...
export const TypeId: TypeId = "~@noxijent-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@noxijent-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@noxijent-ai/effect-sqlite-node/NodeSqliteClient")
