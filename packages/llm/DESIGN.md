...
> current private `@noxijent-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@noxijent-ai/ai`
...
- Secondary audience: Noxijent and other durable agent runtimes
...
import { LLM } from "@noxijent-ai/ai"
import { OpenAI } from "@noxijent-ai/ai/providers/openai"
...
```ts
import { Message } from "@noxijent-ai/ai"
...
import { LLM, Tool } from "@noxijent-ai/ai"
...
Noxijent and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@noxijent-ai/ai/promise"
import { OpenAI } from "@noxijent-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@noxijent-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@noxijent-ai/ai/provider"
...
@noxijent-ai/ai/promise
  Promise/AsyncIterable LLM facade

@noxijent-ai/ai/schema
  serializable domain schemas

@noxijent-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@noxijent-ai/ai/providers/openai
@noxijent-ai/ai/providers/anthropic
@noxijent-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@noxijent-ai/llm`                      | `@noxijent-ai/ai`                                           |
...
Noxijent should migrate to `generateTurn` / `streamTurn`, preserving its durable
