...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/noxijent`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy noxijent service removed
