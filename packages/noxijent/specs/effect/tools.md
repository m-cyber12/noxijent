...
Practical reference for the current tool-migration state in `packages/noxijent`.
...
Tool tests should use the existing Effect helpers in `packages/noxijent/test/lib/effect.ts`:
