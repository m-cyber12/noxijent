...
import { AccountStateTable, AccountTable } from "@noxijent-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/AccountRepo") {}
