...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@noxijent/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@noxijent/ACPDirectory") {}
