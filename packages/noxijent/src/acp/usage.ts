...
import type { AssistantMessage as NoxijentAssistantMessage, Message } from "@noxijent-ai/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@noxijent-ai/core/effect/app-node"
...
export type AssistantTokenCost = Pick<NoxijentAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<NoxijentAssistantMessage, "role"> &
  Partial<Pick<NoxijentAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@noxijent/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@noxijent/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@noxijent/ACPUsage") {}
