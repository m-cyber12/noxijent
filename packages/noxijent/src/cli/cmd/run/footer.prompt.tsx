...
import { normalizePromptContent } from "@noxijent-ai/tui/editor"
...
import { NOXIJENT_BASE_MODE, useBindings } from "@noxijent-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Noxijent" } satisfies SlashOption,
    ]
