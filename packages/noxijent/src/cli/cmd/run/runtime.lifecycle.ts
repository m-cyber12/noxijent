...
import { openEditor } from "@noxijent-ai/tui/editor"
import { registerNoxijentKeymap } from "@noxijent-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerNoxijentKeymap(keymap, renderer, input.tuiConfig)
