...
import type { Event, GlobalEvent, NoxijentClient } from "@noxijent-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@noxijent/RunStreamTransport") {}
