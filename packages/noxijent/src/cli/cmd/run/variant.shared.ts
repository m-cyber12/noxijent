...
//
// The saved variant persists across sessions in ~/.local/state/noxijent/model.json
...
class Service extends Context.Service<Service, VariantService>()("@noxijent/RunVariant") {}
