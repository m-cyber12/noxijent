...
import { EventSequenceTable, EventTable } from "@noxijent-ai/core/event/sql"
...
import { WorkspaceEvent } from "@noxijent-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        NOXIJENT_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        NOXIJENT_WORKSPACE_ID: config.id,
        NOXIJENT_EXPERIMENTAL_WORKSPACES: "true",
