 ...
 *   "@noxijent/ServerAuthConfig",
 *   {
 *     password: Config.string("NOXIJENT_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("NOXIJENT_SERVER_USERNAME").pipe(Config.withDefault("noxijent")),
 *   },
 * ) {}
 *
