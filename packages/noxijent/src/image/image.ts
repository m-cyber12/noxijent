...
export class Service extends Context.Service<Service, Interface>()("@noxijent/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __NOXIJENT_PHOTON_WASM_PATH?: string }).__NOXIJENT_PHOTON_WASM_PATH =
