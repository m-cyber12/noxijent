import type { Hooks, PluginInput } from "@noxijent-ai/plugin"
import type { Model } from "@noxijent-ai/sdk/v2"
import { InstallationVersion } from "@noxijent-ai/core/installation/version"
import { OauthCallbackPage } from "@noxijent-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Noxijent will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
