...
import { ProjectDirectoryTable, ProjectTable } from "@noxijent-ai/core/project/sql"
import { ProjectDirectories } from "@noxijent-ai/core/project/directories"
import { SessionTable } from "@noxijent-ai/core/session/sql"
import { WorkspaceTable } from "@noxijent-ai/core/control-plane/workspace.sql"
import { Flag } from "@noxijent-ai/core/flag/flag"
import { GlobalBus } from "@/bus/global"
import { which } from "@noxijent-ai/core/util/which"
...
import { CrossSpawnSpawner } from "@noxijent-ai/core/cross-spawn-spawner"
import { AbsolutePath } from "@noxijent-ai/core/schema"
import { serviceUse } from "@noxijent-ai/core/effect/service-use"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { EventV2Bridge } from "@/event-v2-bridge"
import { EventV2 } from "@noxijent-ai/core/event"
import { Project } from "@noxijent-ai/schema/project"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.NOXIJENT_FAKE_VCS)
