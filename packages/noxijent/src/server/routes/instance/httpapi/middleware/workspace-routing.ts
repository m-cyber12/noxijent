...
>()("@noxijent/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@noxijent/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.NOXIJENT_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.NOXIJENT_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-noxijent-directory"] || process.cwd()
}
