...
import { buildPrompt } from "@noxijent-ai/core/session/compaction"
import { SessionCompactionEvent } from "@noxijent-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/SessionCompaction") {}
