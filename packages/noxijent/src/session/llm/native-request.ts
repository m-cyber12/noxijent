import type { JsonSchema, LLMRequest, ProviderMetadata } from "@noxijent-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@noxijent-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
  ...
  OpenAICompatible,
  OpenRouter,
} from "@noxijent-ai/llm/providers"
...
export const request = (input: RequestInput) => {
  ...
  // @noxijent-ai/llm request objects from noxijent's session/AI SDK-shaped data.
  return LLM.request({
