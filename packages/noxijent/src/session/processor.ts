...
import { Usage, type LLMEvent } from "@noxijent-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean noxijent changed history behind a signed
