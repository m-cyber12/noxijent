...
import { SessionStatusEvent } from "@noxijent-ai/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/SessionStatus") {}
