...
import type * as SDK from "@noxijent-ai/sdk/v2"
...
import { SessionShareTable } from "@noxijent-ai/core/share/sql"
...
const disabled = process.env["NOXIJENT_DISABLE_SHARE"] === "true" || process.env["NOXIJENT_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@noxijent/ShareNext") {}
