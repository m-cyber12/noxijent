...
- Effect plugins import `@noxijent-ai/plugin/v2/effect`, not `@noxijent-ai/core`.
- Public domain values use generated `@noxijent-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@noxijent-ai/plugin/v2/effect`.
