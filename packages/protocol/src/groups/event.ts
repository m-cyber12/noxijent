...
import type { Definition } from "@noxijent-ai/schema/event"
...
export const NoxijentEvent = event.schema
export type NoxijentEvent = typeof NoxijentEvent.Type
export type NoxijentEventEncoded = typeof NoxijentEvent.Encoded
