import { Noxijent } from "@noxijent-ai/client/effect"
...
import { ApplicationTools } from "@noxijent-ai/core/tool/application-tools"
import { createEmbeddedRoutes } from "@noxijent-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Noxijent.create")(function* () {
  ...
  const client = yield* Noxijent.make({ baseUrl: "http://noxijent.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@noxijent-ai/sdk-next/Noxijent") {}
