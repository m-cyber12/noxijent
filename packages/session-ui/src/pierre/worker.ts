...
import { registerNoxijentTheme } from "@noxijent-ai/ui/context/marked-theme-register"

registerNoxijentTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for Noxijent, as I think 8 might be
