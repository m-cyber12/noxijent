...
const en = {
  "app.title": "AI Model Usage Rankings | Noxijent Data",
  "app.description":
    "Explore Noxijent usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Noxijent Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Noxijent on GitHub",
  "header.github": "GitHub",
  "header.tryNoxijent": "Try Noxijent",
  ...
  "home.topModelsDescription": "Usage of models across Noxijent.",
  ...
  "home.uniqueUsersDescription": "Daily unique Noxijent users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Noxijent Data",
  "lab.description":
    "Compare {{lab}} models used in Noxijent, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Noxijent usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Noxijent",
  ...
  "lab.shareOfUsage": "{{share}} of recent Noxijent usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Noxijent Data",
  "model.description":
    "View {{model}} Noxijent usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Noxijent usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Noxijent usage",
  "model.ranked": "Ranked #{{rank}} across last week's Noxijent usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Noxijent usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Noxijent usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No Noxijent geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent Noxijent token volume.",
