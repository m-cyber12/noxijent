export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Noxijent Data",
  "app.description":
    "Explore o uso do Noxijent em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Noxijent Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Noxijent no GitHub",
  "header.github": "GitHub",
  "header.tryNoxijent": "Experimente o Noxijent",
  ...
  "footer.homeAria": "Início do Noxijent",
  ...
  "modal.title": "Newsletter do Noxijent",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Noxijent.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Noxijent por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Noxijent Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Noxijent, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Noxijent.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Noxijent",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Noxijent",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Noxijent nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Noxijent Data",
  "model.description":
    "Veja dados de uso de {{model}} no Noxijent, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Noxijent aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Noxijent da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Noxijent da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Noxijent na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Noxijent, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Noxijent.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Noxijent na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Noxijent na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Noxijent.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Noxijent correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Noxijent.",
