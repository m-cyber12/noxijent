export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Noxijent Data",
  "app.description":
    "Esplora l'utilizzo di Noxijent nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Noxijent Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Noxijent su GitHub",
  "header.github": "GitHub",
  "header.tryNoxijent": "Prova Noxijent",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Noxijent.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Noxijent per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Noxijent Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Noxijent, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Noxijent.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Noxijent",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Noxijent",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Noxijent negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Noxijent Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Noxijent, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Noxijent appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Noxijent della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Noxijent della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Noxijent nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Noxijent, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Noxijent.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Noxijent nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Noxijent nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Noxijent.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Noxijent corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Noxijent.",
