export const dict = {
  "app.title": "Rankingi użycia modeli AI | Noxijent Data",
  "app.description":
    "Przeglądaj użycie Noxijent w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Noxijent Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Noxijent na GitHub",
  "header.github": "GitHub",
  "header.tryNoxijent": "Wypróbuj Noxijent",
  ...
  "footer.homeAria": "Strona główna Noxijent",
  ...
  "home.topModelsDescription": "Użycie modeli w Noxijent.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Noxijent według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Noxijent Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Noxijent, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Noxijent.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Noxijent",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Noxijent",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Noxijent z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Noxijent Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Noxijent, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Noxijent pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Noxijent z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Noxijent z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Noxijent w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Noxijent, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Noxijent.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Noxijent w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Noxijent w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Noxijent.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Noxijent nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Noxijent.",
