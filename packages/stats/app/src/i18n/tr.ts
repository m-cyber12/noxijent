export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Noxijent Data",
  "app.description":
    "Noxijent kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Noxijent Data logosu",
  ...
  "header.githubAria": "GitHub'da Noxijent'a yıldız ver",
  "header.github": "GitHub",
  "header.tryNoxijent": "Noxijent'u dene",
  ...
  "footer.homeAria": "Noxijent ana sayfası",
  ...
  "home.topModelsDescription": "Noxijent genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Noxijent kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Noxijent Data",
  "lab.description":
    "Noxijent'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Noxijent kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Noxijent'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Noxijent kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Noxijent token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Noxijent Data",
  "model.description":
    "{{model}} için Noxijent kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Noxijent kullanımı görünür.",
  "model.unranked": "Geçen haftaki Noxijent kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Noxijent kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Noxijent kullanımı yok.",
  ...
  "model.overviewDescription": "Son Noxijent tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Noxijent kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Noxijent token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Noxijent kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Noxijent oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen Noxijent coğrafi satırı yok.",
  "model.peersDescription": "Son Noxijent token hacmine göre yakındaki modeller.",
