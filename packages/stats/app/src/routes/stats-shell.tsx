import noxijentWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/anomalyco/noxijent",
  fallbackStars: "195K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "noxijent:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://noxijent.ai/">
            <strong>{i18n.t("header.tryNoxijent")}</strong>
          </a>
          <button
...
function NoxijentMark() {
  return (
    <svg data-slot="noxijent-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://noxijent.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://noxijent.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@noxijent.ai", label: i18n.t("footer.contact") },
    { href: "https://noxijent.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/noxijent", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://noxijent.ai" aria-label={i18n.t("footer.homeAria")}>
          <NoxijentMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={noxijentWordmarkDark} alt="Noxijent" />
          <button
