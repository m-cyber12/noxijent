...
import { registerNoxijentSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@noxijent-ai/sdk/v2"
...
import { NOXIJENT_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useNoxijentKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.NOXIJENT_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
