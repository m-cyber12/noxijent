...
import { IconNoxijent } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "noxijent/session/message-v2"
import type { Message } from "noxijent/session/message"
import type { Session } from "noxijent/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.noxijent_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.noxijent_name}>
                    <IconNoxijent width={16} height={16} />
                  </div>
