...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في noxijent.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في noxijent مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.noxijent/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/noxijent/tools/`.
