---
title: TUI
description: استخدام واجهة المستخدم TUI في Noxijent.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Noxijent واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Noxijent إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Noxijent في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Noxijent. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Noxijent. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `noxijent.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Noxijent بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `noxijent.default`.
