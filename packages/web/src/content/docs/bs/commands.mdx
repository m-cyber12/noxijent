...
Kreiraj `.noxijent/commands/test.md`:
...
Možete dodati prilagođene komande kroz Noxijent konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Noxijent [config](/docs/config):
...
- Globalno: `~/.config/noxijent/commands/`
- Po projektu: `.noxijent/commands/`
...
Noxijent uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
