...
Noxijent Go je povoljna pretplata od **$10/mjesečno** koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

Go radi kao bilo koji drugi provajder u Noxijent-u. Pretplatite se na Noxijent Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili Noxijent.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa Noxijent-om.
:::
...
Noxijent Go vam daje pristup ovim modelima za **$10/mjesečno**.

---

## Kako funkcioniše

Noxijent Go radi kao bilo koji drugi provajder u Noxijent-u.

1. Prijavite se na **<a href={console}>Noxijent Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `Noxijent Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na Noxijent Go.
:::
...
- **Hy4 preview**
- **Hy3**
- **Union Alpha Free** (ograničeno vrijeme)
...
Noxijent Go je osmišljen za [Noxijent](https://noxijent.ai) i druge agente za programiranje
...
3. Slati stabilan ID sesije u zaglavlju `x-noxijent-session` za svaki razgovor kako bismo mogli optimizovati usmjeravanje i
   keširanje promptova.

### Provjereni klijenti

Pored Noxijent-a, potvrđeno je da sljedeći klijenti ispravno rade
s Noxijent Go. Ipak, ne garantiramo da će nastaviti raditi i u budućnosti.

| Klijent           | Podrška za sesije                                                                                                                                                                                                                                          |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Buildovi koji sadrže [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) šalju zaglavlje u glavnim i pomoćnim Noxijent zahtjevima. Ispravka je spojena nakon verzije v0.21.0; samo to izdanje je ne sadrži.                             |
...
| **ZCode**         | Go prepoznaje njegovo izvorno zaglavlje sesije. Naš [zahtjev za `x-noxijent-session`](https://github.com/zai-org/feedback/issues/492) i dalje je otvoren, ali slanje tog konkretnog zaglavlja više nije potrebno.                                          |
| **Pi**            | Trenutni buildovi šalju informacije o sesiji za Noxijent. Ažurirajte starije instalacije.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Buildovi koji sadrže [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) vraćaju Noxijent zaglavlja sesije. Ova ispravka obuhvata CLI, ali ne i VS Code ekstenziju. Pogledajte [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
| Union Alpha Free                        | Free   | Free   | Free        | -            | **Neograničeno**<br /><small>ograničeno vrijeme</small>   |
...
| Union Alpha Free                                              | Neograničeno              | Neograničeno               | Neograničeno                |
...
[Model id](/docs/config/#models) u vašoj Noxijent konfiguraciji
koristi format `noxijent-go/<model-id>`. Na primjer, za Kimi K3, koristili biste
`noxijent-go/kimi-k3` u svojoj konfiguraciji.
...
| Union Alpha Free             | Ne koristi se     | 0 dana               |
...
Napravili smo Noxijent Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz Noxijent koristite i bilo kojeg drugog provajdera.
