---
title: LSP serveri
description: Noxijent se integriše sa vašim LSP serverima.
---

Noxijent se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Noxijent dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `NOXIJENT_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i noxijent otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj noxijent konfiguraciji.
