---
title: TUI
description: Korištenje korisničkog interfejsa Noxijent terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Noxijent pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Noxijent pokreće TUI za trenutni direktorij.
...
Kada koristite Noxijent TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Noxijent. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Noxijent. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `noxijent.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Noxijent čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `noxijent.default`.
