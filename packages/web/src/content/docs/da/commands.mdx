...
Opret `.noxijent/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem Noxijent-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Noxijent [config](/docs/config):
...
- Globalt: `~/.config/noxijent/commands/`
- Pr. projekt: `.noxijent/commands/`
...
noxijent indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
