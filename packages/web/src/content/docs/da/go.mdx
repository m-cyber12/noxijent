...
Noxijent Go er et lavprisabonnement til **$10/måned**, der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i Noxijent. Du abonnerer på Noxijent Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Noxijent.
:::
...
Noxijent Go giver dig adgang til disse modeller for **$10/måned**.

---

## Sådan fungerer det

Noxijent Go fungerer som enhver anden udbyder i Noxijent.

1. Du logger ind på **<a href={console}>Noxijent Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `Noxijent Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på Noxijent Go.
:::
...
- **Hy4 preview**
- **Hy3**
- **Union Alpha Free** (i en begrænset periode)
...
Noxijent Go er udviklet til [Noxijent](https://noxijent.ai) og andre kodningsagenter,
...
3. Sende et stabilt sessions-id i `x-noxijent-session` for hver samtale, så vi kan optimere routing og
   prompt-caching.

### Validerede klienter

Ud over Noxijent er følgende klienter blevet valideret til at fungere korrekt
med Noxijent Go. Vi garanterer dog ikke, at de fortsat vil fungere fremover.

| Klient            | Sessionsunderstøttelse                                                                                                                                                                                                                                    |
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Builds, der indeholder [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864), sender headeren i primære og sekundære Noxijent-anmodninger. Rettelsen blev merged efter v0.21.0; den version indeholder den ikke i sig selv.              |
...
| **ZCode**         | Go genkender dens indbyggede sessionsheader. Vores [anmodning om `x-noxijent-session`](https://github.com/zai-org/feedback/issues/492) er stadig åben, men det er ikke længere nødvendigt at sende netop denne header.                                    |
| **Pi**            | Aktuelle builds sender sessionsoplysninger til Noxijent. Opdater ældre installationer.                                                                                                                                                                    |
...
| **Kilo Code CLI** | Builds, der indeholder [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752), gendanner Noxijent-sessionsheadere. Denne rettelse dækker CLI'en, men ikke VS Code-udvidelsen. Se [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
| Union Alpha Free                        | Free   | Free   | Free        | -            | **Ubegrænset**<br /><small>i en begrænset periode</small> |
...
| Union Alpha Free                                              | Ubegrænset                | Ubegrænset                 | Ubegrænset                  |
...
Dit [model id](/docs/config/#models) i din Noxijent config
bruger formatet `noxijent-go/<model-id>`. For eksempel for Kimi K3, vil du
bruge `noxijent-go/kimi-k3` i din config.
...
| Union Alpha Free             | Ikke brugt   | 0 dage         |
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Noxijent.
