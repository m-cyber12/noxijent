...
Brug den til at bygge integrasjoner og kontrollere noxijent programmatisk.
...
Opret en forekomst av noxijent:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `noxijent.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av noxijent, kan du oprete en klientforekomst for at koble til den:
