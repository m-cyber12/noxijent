...
Her er alle de innebygde verktøyene som er tilgængelige i Noxijent.
...
:::note
Dette verktøyet er bare tilgængelig når `NOXIJENT_EXPERIMENTAL_LSP_TOOL=true` (eller `NOXIJENT_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Noxijent-leverandøren eller når miljøvariabelen `NOXIJENT_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
