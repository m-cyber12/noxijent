---
title: TUI
description: Brug af Noxijent-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Noxijent giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre Noxijent starter TUI for den nuværende mappe.
...
Når du bruger Noxijent TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til Noxijent. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut Noxijent. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `noxijent.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe Noxijent venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `noxijent.default`.
