---
title: SDK
description: Typsicherer JS-Client fuer den noxijent-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das noxijent JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und noxijent programmatisch steuern.
...
Erstelle eine noxijent-Instanz:
...
`noxijent.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn noxijent bereits laeuft, kannst du nur einen Client erstellen und verbinden:
