---
title: Teilen
description: Teile Noxijent-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Noxijent-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Noxijent Folgendes:
...
Noxijent hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Noxijent den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`noxijent.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du noxijent in deiner Organisation einsetzt.
