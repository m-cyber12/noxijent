...
Crear `.noxijent/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Noxijent o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Noxijent [config](/docs/config):
...
- Por proyecto: `.noxijent/commands/`
...
noxijent incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
