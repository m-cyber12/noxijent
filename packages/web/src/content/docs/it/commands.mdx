...
Crea `.noxijent/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di Noxijent o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Noxijent:
...
- Globale: `~/.config/noxijent/commands/`
- Per progetto: `.noxijent/commands/`
...
noxijent include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
