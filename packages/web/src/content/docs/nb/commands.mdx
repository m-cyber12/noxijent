...
Opprett `.noxijent/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Noxijent-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Noxijent [config](/docs/config):
...
- Per prosjekt: `.noxijent/commands/`
...
Noxijent inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
