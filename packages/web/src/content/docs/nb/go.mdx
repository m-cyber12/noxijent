...
Noxijent Go er et lavkostnadsabonnement til **$10/måned** som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i Noxijent. Du abonnerer på Noxijent Go og
...
Noxijent Go gir deg tilgang til disse modellene for **$10/måned**.

---

## Hvordan det fungerer

Noxijent Go fungerer som enhver annen leverandør i Noxijent.

1. Du logger inn på **<a href={console}>Noxijent Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `Noxijent Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på Noxijent Go.
:::
...
- **Hy4 preview**
- **Hy3**
- **Union Alpha Free** (i en begrenset periode)
...
Noxijent Go er utviklet for [Noxijent](https://noxijent.ai) og andre kodeagenter
...
3. Sende en stabil sesjons-ID i `x-noxijent-session` for hver samtale, slik at vi kan optimalisere ruting og
   promptbufring.

### Validerte klienter

I tillegg til Noxijent er følgende klienter validert for å fungere riktig
med Noxijent Go. Vi garanterer imidlertid ikke at de vil fortsette å fungere i fremtiden.

| Klient            | Sesjonsstøtte                                                                                                                                                                                                                                          |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Hermes**        | Bygg som inneholder [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864), sender headeren i primære og sekundære Noxijent-forespørsler. Rettelsen ble slått sammen etter v0.21.0; den versjonen inneholder den ikke alene.           |
...
| **ZCode**         | Go gjenkjenner den innebygde sesjonsheaderen. Vår [forespørsel om `x-noxijent-session`](https://github.com/zai-org/feedback/issues/492) er fortsatt åpen, men det er ikke lenger nødvendig å sende akkurat denne headeren.                             |
| **Pi**            | Gjeldende bygg sender sesjonsinformasjon for Noxijent. Oppdater eldre installasjoner.                                                                                                                                                                  |
...
| **Kilo Code CLI** | Bygg som inneholder [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752), gjenoppretter Noxijent-sesjonsheadere. Denne rettelsen dekker CLI-en, ikke VS Code-utvidelsen. Se [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
| Union Alpha Free                        | Free   | Free   | Free        | -            | **Ubegrenset**<br /><small>i en begrenset periode</small> |
...
| Union Alpha Free                                              | Ubegrenset                | Ubegrenset                 | Ubegrenset                  |
...
[Modell-ID-en](/docs/config/#models) i din Noxijent-konfigurasjon
bruker formatet `noxijent-go/<model-id>`. For eksempel, for Kimi K3, vil du
bruke `noxijent-go/kimi-k3` i konfigurasjonen din.
...
| Union Alpha Free             | Brukes ikke   | 0 dager         |
...
Vi opprettet Noxijent Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med Noxijent også.
