...
Agentferdigheter lar Noxijent oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går noxijent opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
noxijent viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `noxijent.json`:
