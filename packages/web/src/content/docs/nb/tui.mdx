---
title: TUI
description: Bruke noxijent-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Noxijent gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Noxijent starter TUI for gjeldende katalog.
...
Når du bruker Noxijent TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Noxijent. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Noxijent. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `noxijent.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Noxijent venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `noxijent.default`.
