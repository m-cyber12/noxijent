...
Utwórz `.noxijent/commands/test.md`:
...
Możesz zdefiniować polecenia w `noxijent.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji noxijent:
...
- Globalnie: `~/.config/noxijent/commands/`
- Na projekt: `.noxijent/commands/`
...
noxijent zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
