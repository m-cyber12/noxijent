...
Noxijent Go to niskokosztowa subskrypcja za **10 $/miesiąc**, która zapewnia niezawodny dostęp do popularnych otwartych modeli do kodowania.

Go działa jak każdy inny dostawca w Noxijent. Subskrybujesz Noxijent Go i
...
Noxijent Go daje Ci dostęp do tych modeli za **10 $/miesiąc**.

---

## Jak to działa

Noxijent Go działa jak każdy inny dostawca w Noxijent.

1. Logujesz się do **<a href={console}>Noxijent Zen</a>**, subskrybujesz Go i
   kopiujesz swój klucz API.
2. Uruchamiasz komendę `/connect` w TUI, wybierasz `Noxijent Go` i wklejasz
   swój klucz API.
3. Uruchom `/models` w TUI, aby zobaczyć listę modeli dostępnych w ramach Go.

:::note
Tylko jeden członek na obszar roboczy (workspace) może zasubskrybować Noxijent Go.
:::
...
- **Hy4 preview**
- **Hy3**
- **Union Alpha Free** (przez ograniczony czas)
...
Noxijent Go jest przeznaczony dla [Noxijent](https://noxijent.ai) i innych agentów kodujących,
...
3. Wysyłać stabilny identyfikator sesji w nagłówku `x-noxijent-session` dla każdej rozmowy, aby umożliwić optymalizację routingu i
   buforowania promptów.

### Zweryfikowane klienty

Poza Noxijent zweryfikowano, że poniżsi klienci działają prawidłowo
z Noxijent Go. Nie gwarantujemy jednak, że będą nadal działać w przyszłości.

| Klient            | Obsługa sesji                                                                                                                                                                                                                                              |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Hermes**        | Kompilacje zawierające [PR #101864](https://github.com/NousResearch/hermes-agent/pull/101864) wysyłają nagłówek w głównych i pomocniczych żądaniach Noxijent. Poprawkę scalono po wersji v0.21.0; samo to wydanie jej nie zawiera.                         |
...
| **ZCode**         | Go rozpoznaje jego natywny nagłówek sesji. Nasza [prośba o `x-noxijent-session`](https://github.com/zai-org/feedback/issues/492) pozostaje otwarta, ale wysyłanie tego konkretnego nagłówka nie jest już konieczne.                                        |
| **Pi**            | Aktualne kompilacje wysyłają informacje o sesji dla Noxijent. Zaktualizuj starsze instalacje.                                                                                                                                                              |
...
| **Kilo Code CLI** | Kompilacje zawierające [PR #13752](https://github.com/Kilo-Org/kilocode/pull/13752) przywracają nagłówki sesji Noxijent. Ta poprawka obejmuje CLI, ale nie rozszerzenie VS Code. Zobacz [issue #13723](https://github.com/Kilo-Org/kilocode/issues/13723). |
...
| Union Alpha Free                        | Free    | Free    | Free           | -              | **Bez limitu**<br /><small>przez ograniczony czas</small> |
...
| Union Alpha Free                                            | Bez limitu                | Bez limitu                 | Bez limitu                  |
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Noxijent
używa formatu `noxijent-go/<model-id>`. Na przykład dla Kimi K3 należy użyć
`noxijent-go/kimi-k3` w swojej konfiguracji.
...
| Union Alpha Free             | Niewykorzystywane | 0 dni           |
...
4. Zapewnić **brak ograniczeń (no lock-in)**, pozwalając na korzystanie z dowolnego innego dostawcy wraz z Noxijent.
