---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala noxijent.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

noxijent zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie noxijent uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI noxijent, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do noxijent. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij noxijent. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `noxijent.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Noxijent czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `noxijent.default`.
