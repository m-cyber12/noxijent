...
สร้าง `.noxijent/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Noxijent:
...
- ระดับผู้ใช้ (Global): `~/.config/noxijent/commands/`
- ระดับโปรเจ็กต์: `.noxijent/commands/`
...
Noxijent มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
