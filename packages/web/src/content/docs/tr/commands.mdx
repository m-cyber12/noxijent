...
`.noxijent/commands/test.md` oluştur:
...
noxijent işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

noxijent [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/noxijent/commands/`
- Proje başına: `.noxijent/commands/`
...
noxijent, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
