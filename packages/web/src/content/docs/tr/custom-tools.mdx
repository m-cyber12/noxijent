---
title: Özel Araçlar
description: LLM'un noxijent'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. noxijent'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.noxijent/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/noxijent/tools/` içine yerleştirerek.
