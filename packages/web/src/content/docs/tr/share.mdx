---
title: Paylasim
description: noxijent konusmalarini genel baglantilarla paylasin.
---

noxijent'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda noxijent:
...
noxijent, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak noxijent manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `noxijent.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda noxijent kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
