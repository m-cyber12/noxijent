...
Generates UPCOMING_CHANGELOG.md by running the noxijent changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for noxijent run (default: low)
      --quiet            Suppress noxijent command output unless it fails
