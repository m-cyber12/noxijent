...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/noxijent/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/noxijent...\n")
...
console.log("Fetching npm all-time downloads for noxijent-ai...\n")
const npmDownloads = await fetchNpmDownloads("noxijent-ai")
